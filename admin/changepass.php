...
$username=$_SESSION['adminUser'];
    $sql ="SELECT adminPassword FROM tbl_admin WHERE adminUser=:username and adminPassword=:password";
...
if($query -> rowCount() > 0)
{
$con="update tbl_admin set adminPassword=:newpassword where adminUser=:username";
