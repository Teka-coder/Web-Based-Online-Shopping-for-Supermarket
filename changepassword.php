...
$username=$_SESSION['cuslogin'];
    $sql ="SELECT pass FROM tbl_customer WHERE email=:username and pass=:password";
...
if($query -> rowCount() > 0)
{
$con="update tbl_customer set pass=:newpassword where email=:username";
