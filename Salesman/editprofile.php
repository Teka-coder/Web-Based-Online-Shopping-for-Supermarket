    		...
    		if ($getdata) {
    		 ...
    		 <form action="" method="post">
				<table class="tblone">
					...
					<tr>
						<td>Street</td>
						<td><input type="text" name="street" value="<?php echo $result['street'];?>"></td>
					</tr>
					
<tr>
	<td>Secret question</td>
  <td><select id="select" name="secretQuest" value="<?php echo $result['secretQuest'];?>">

                            <option><?php echo $result['secretQuest'];?></option>
...
<tr>
						<td>Answer</td>
						<td><input type="text" name="secretAns" value="<?php echo $result['secretAns'];?>"></td>
					</tr>
					<tr>
						<td>Password</td>
						<td><input type="password" name="pass" value="<?php echo md5($result['pass']);?>"></td>
					</tr>
					<tr>
						<td></td>
