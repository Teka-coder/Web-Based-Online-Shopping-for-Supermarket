...
<html lang="en">
    <head>
        ...
        <!-- Title -->
        <title>Salesman Password Recovery</title>
...
.succWrap{
    ...
    <body>
            ...
            <main class="mn-inner">
                <div class="row">
                    <div class="col s12">
                        <div class="page-title"><h4>Salesman Password Recovery</h4></div>

                          <div class="col s12 m6 l8 offset-l2 offset-m3">
                              <div class="card white darken-1">

                                  <div class="card-content ">
                                      <span class="card-title" style="font-size:20px;">Salesman details</span>
...
die("error in selection db".mysqli_error());
    ...
    $resulsasst = mysqli_query($connect, "SELECT * FROM tbl_salesman WHERE salesmanUser = '$username'");
    ...
    if(strlen($new_password) <=5 ) {
     echo '<div class="alert alert-dismissable alert-error">';
        ...
        $chack = mysqli_query($connect, "UPDATE tbl_salesman SET salesmanPassword='$new_password' WHERE salesmanUser = '$username'");
...
die("error in selection db".mysqli_error());
    ...
    $result = mysqli_query($connect, "SELECT * FROM tbl_salesman WHERE secretWord = '$secretWord' and secretNumber='$secretNumber'");
