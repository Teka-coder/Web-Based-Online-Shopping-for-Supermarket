...
//SMS
							...
							$textlocal = new Textlocal('tekaberako475@gmail.com', '3b98c30288b4a9bbfc067a1a4a3929');
						 
							$numbers = array($rphone1);
							$sender = 'GET MONEY';
							$message = 'Withdrawn '.$amount1.' Birr Successful .';
...
<script type="text/javascript">
	function rcvphncheck(){
		...
		if(!testrphone){
			document.getElementById("rphneror").innerHTML = "Please give a valid Sender Phone With +251 !!";
			return false;
		}
