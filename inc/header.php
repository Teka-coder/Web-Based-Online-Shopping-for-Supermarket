...
<html lang="en-US">
<head>
<title>Senait Supermarket online shopping</title>
<meta charset="UTF-8">
...
<div class="shopping_cart">
					<div class="cart">
						<a title="Current user" rel="nofollow">
								<span class="customer_titile">Welcome: <?php echo $result['name'];?></span>
...
<?php } ?>
	  ...
	  <?php 
		$login = Session::get("cuslogin");
		if ($login == true) { ?>
		<a href="radduser.php">Register to recommended</a> 
		<?php } ?>
		 <?php 
		$login = Session::get("cuslogin");
		if ($login == true) { ?>
		<a href="rrecommendation.php">Recommended</a> 
		<?php } ?>
